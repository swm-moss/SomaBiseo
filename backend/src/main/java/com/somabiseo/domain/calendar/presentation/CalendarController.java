...
public class CalendarController {
    ...
    ApiResponse<CalendarConnectionResponse> getConnection(
        ...
        return ApiResponse.ok(calendarService.getConnection(googleSessionId(authorization, request, response)));
    }
    ...
    ApiResponse<CalendarConnectionResponse> disconnect(
        ...
        return ApiResponse.ok(calendarService.disconnect(googleSessionId(authorization, request, response)));
    }
    ...
    ApiResponse<List<GoogleCalendarEventResponse>> getGoogleEvents(
        ...
        return ApiResponse.ok(calendarService.getGoogleEvents(googleSessionId(authorization, request, response), from, to));
    }
    ...
    ApiResponse<CalendarEventLinkResponse> addEvent(
        ...
        return ApiResponse.ok(calendarService.addEvent(googleSessionId(authorization, request, response), eventId));
    }
    ...
    private String googleSessionId(String authorization, HttpServletRequest request, HttpServletResponse response) {
